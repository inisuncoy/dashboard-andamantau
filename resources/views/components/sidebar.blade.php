        ...
        <div>
            ...
            <div class="flex flex-col gap-y-2">
                ...
                <a href="/produk" class="px-5 py-1 flex items-center gap-x-5 mx-2">
                    <span>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.66667 6.66663H9.37606C10.1953 6.66663 10.6049 6.66663 10.9456 6.80985C11.246 6.9361 11.5073 7.1401 11.7026 7.40087C11.9242 7.69671 12.0235 8.09409 12.2222 8.88885L12.5249 10.0995C12.6333 10.5331 12.6875 10.7499 12.7568 10.9374C13.2385 12.2411 14.4159 13.1604 15.7975 13.3116C15.9963 13.3333 16.2197 13.3333 16.6667 13.3333V13.3333" stroke="#FFDA00" stroke-width="3" stroke-linecap="round"/>
                            <path d="M30 28.3334H12.5848C12.548 28.3334 12.5296 28.3334 12.5155 28.3332C11.2879 28.3143 10.4253 27.1176 10.7957 25.947C10.7999 25.9336 10.8057 25.9161 10.8174 25.8812V25.8812C10.8303 25.8423 10.8368 25.8229 10.8429 25.8054C11.3482 24.3391 12.7214 23.3493 14.2723 23.3336C14.2909 23.3334 14.3114 23.3334 14.3523 23.3334H23.3333" stroke="#FFDA00" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M23.8011 23.3334H18.2905C16.537 23.3334 15.6602 23.3334 14.9483 23.0164C14.3098 22.7322 13.7658 22.2714 13.3805 21.6883C12.9508 21.0382 12.8067 20.1733 12.5184 18.4437C12.2266 16.6931 12.0808 15.8179 12.3316 15.135C12.5557 14.5252 12.9884 14.0144 13.5531 13.6931C14.1854 13.3334 15.0728 13.3334 16.8475 13.3334H27.4006C30.0596 13.3334 31.3891 13.3334 31.9265 14.2029C32.4638 15.0724 31.8693 16.2615 30.6801 18.6398L30.3602 19.2796C29.374 21.252 28.881 22.2381 27.9949 22.7858C27.1088 23.3334 26.0063 23.3334 23.8011 23.3334Z" stroke="#FFDA00" stroke-width="3" stroke-linecap="round"/>
                ...
                <div class="px-5 py-1 flex items-center gap-x-5 mx-2">
                    <span>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13 28.2572L18.4185 16.736C18.4851 16.5944 18.6898 16.6047 18.7419 16.7523L21.2581 23.8859C21.3102 24.0335 21.5149 24.0438 21.5815 23.9022L27 12.381" stroke="#08A3E1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                            <rect width="30" height="30" rx="0.35" transform="matrix(-1 0 0 1 35 5)" stroke="#08A3E1" stroke-width="3"/>
                        </svg>
                    </span>
