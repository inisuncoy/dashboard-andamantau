    ...
    <div class="grid grid-cols-4 gap-x-10">
        <div class="flex flex-col p-5 bg-white rounded-xl gap-y-3">
            <div class="flex justify-between">
                <div>
                    ...
                    <h1 class="text-[30px] font-[500]">Rp @currencyNonRp($pengeluaran['current_month_expenses'] ?? 0)</h1>
                </div>
                <div>
        ...
        <div class="flex flex-col p-5 bg-white rounded-xl gap-y-3">
            <div class="flex justify-between">
                <div>
                    ...
                    <h1 class="text-[30px] font-[500]">Rp @currencyNonRp($labaBersih['laba_bersih_bulan_ini'] ?? 0)</h1>
                </div>
                <div>
        ...
        <div class="flex flex-col p-5 bg-white rounded-xl gap-y-3">
            ...
            <div>
                ...
                <h1 class="text-[30px] font-[500]">{{ $pesananBaru['total_pesanan_baru_bulan_ini'] ?? 0 }} Barang</h1>
            </div>
            <div>
            ...
            <div class="flex items-center gap-x-2">
            <div class="flex items-end">
                @if ($pesananBaru['percentage_change'] ?? 0)
                    @if ($pesananBaru['percentage_change'] > 0)
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        d="M12 6L12.7071 5.29289L12 4.58579L11.2929 5.29289L12 6ZM11 18C11 18.5523 11.4477 19 12 19C12.5523 19 13 18.5523 13 18L11 18ZM16.7071 9.29289L12.7071 5.29289L11.2929 6.70711L15.2929 10.7071L16.7071 9.29289ZM11.2929 5.29289L7.29289 9.29289L8.70711 10.7071L12.7071 6.70711L11.2929 5.29289ZM11 6L11 18L13 18L13 6L11 6Z"
                    ...
                    <span class="font-inter text-[#16E043] text-[14px] font-bold">{{ number_format($pesananBaru['percentage_change'], 2) }}%</span>
                    @elseif ($pesananBaru['percentage_change'] < 0)
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        d="M12 18L12.7071 18.7071L12 19.4142L11.2929 18.7071L12 18ZM11 6C11 5.44772 11.4477 5 12 5C12.5523 5 13 5.44771 13 6L11 6ZM16.7071 14.7071L12.7071 18.7071L11.2929 17.2929L15.2929 13.2929L16.7071 14.7071ZM11.2929 18.7071L7.29289 14.7071L8.70711 13.2929L12.7071 17.2929L11.2929 18.7071ZM11 18L11 6L13 6L13 18L11 18Z"
                        fill="#FF0000" />
                    </svg>
                    <span class="font-inter text-[#FF0000] text-[14px] font-bold">{{ number_format(abs($pesananBaru['percentage_change']), 2) }}%</span>
                    @else
                    <span class="font-inter text-[#00000080] text-[14px] font-bold">Tidak ada perubahan</span>
                    @endif
                @else
        ...
        <div class="flex flex-col p-5 bg-white rounded-xl gap-y-3">
            ...
            <div>
                ...
                <h1 class="text-[30px] font-[500]">{{ $barangTerjual['total_terjual_barang_bulan_ini'] ?? 0 }} Barang</h1>
            </div>
            <div>
...
<script>
    ...
    document.getElementById('sortByStockButton').addEventListener('click', function() {
        ...
        const newUrl = `{{ url('/dashboard') }}?sortBy=${newSort}`;
