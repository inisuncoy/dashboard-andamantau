  ...
  <form class="bg-white rounded-xl p-5 font-inter">
    ...
    <table class="table-fixed w-full my-5">
      <tbody class="text-[18px]">
        ...
        <tr>
          <td class="w-2/6">Jenis Pemasukan</td>
          <td class="py-2">
            <input type="text" name="jenis_pemasukan" placeholder="Masukan jenis pemasukan"
              class="w-full border-2 border-[#9CD3FF] rounded-md py-2 px-2 placeholder:text-[15px]">
          </td>
        </tr>
        <tr>
          <td class="w-2/6">Total Pemasukan</td>
          <td class="py-2">
            <input type="number" name="total" placeholder="Masukan total pemasukan"
              class="w-full border-2 border-[#9CD3FF] rounded-md py-2 px-2 placeholder:text-[15px]">
          </td>
        </tr>
      </tbody>
    ...
    <div class="flex justify-end gap-5">
      <a href="/pemasukan" class="px-7 py-3 bg-red-500 rounded-lg text-white">Cancel</a>
